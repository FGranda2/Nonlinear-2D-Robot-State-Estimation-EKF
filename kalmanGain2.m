function  [K, G, y_kmeas, g] = kalmanGain2(x_prev,p_prev, r_i, b_i, r_tresh, positions, dist,r_vari,b_vari)
...
for i = 1:sizeTotal
    ...
    G(i,1:3) = vpa(subs(G1,[xk, yk, tetak, xl, yl, d, nk],[x_prev(1,1), x_prev(1,2), x_prev(1,3), positions(1,i), positions(2,i), dist,0]));
...
for j = 1:sizeTotal
    ...
    G(sizeTotal+j,1:3) = vpa(subs(G2,[xk, yk, tetak, xl, yl, d, nk],[x_prev(1,1), x_prev(1,2), x_prev(1,3), positions(1,j), positions(2,j), dist,0]));
